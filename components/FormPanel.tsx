...
const Section: React.FC<SectionProps> = ({ title, children }) => (
  <div className="mb-6 last:mb-0">
    <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-3 px-1">{title}</h3>
    <div className="space-y-4 bg-white p-4 md:p-5 rounded-xl border border-slate-200 shadow-sm">
      {children}
    </div>
  </div>
);
...
const FormPanel: React.FC<FormPanelProps> = ({ data, updateField }) => {
  ...
  return (
    <div className="flex-1 overflow-y-auto px-4 py-6 md:px-6 md:h-[calc(100vh-64px-40px)]">
        ...
        <div className="space-y-4">
          <div>
            <div className="flex justify-between items-center mb-1">
              <label className="block text-sm font-medium text-slate-700 text-xs">Title Size</label>
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              <label className="block text-sm font-medium text-slate-700 text-xs">Details Size</label>
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <input 
                ...
                value={data.accentColor} 
                onChange={e => updateField('accentColor', e.target.value)}
                className="flex-1 px-3 py-2 border border-slate-300 rounded text-xs uppercase"
              />
            </div>
          </div>
          <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center pt-2">
           <div className="flex items-center gap-2">
             <input 
                ...
                id="show-footer"
             />
             <label htmlFor="show-footer" className="text-sm text-slate-700 cursor-pointer">Show Footer</label>
           </div>
           <div>
